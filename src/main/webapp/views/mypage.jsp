...
<body class="page02">
	<div class="b01 pd16">
		<div class="oH w100">
			<div class="name fL">
				<b><c:out value="${vo.uname}"></c:out></b>님 안녕하세요!
			</div>
			<div class="fR">
		...
		<table>
			<tr>
				<td>이름</td>
				<td><c:out value="${vo.uname}"></c:out></td>
			</tr>
			<tr>
				<td>휴대폰 번호</td>
				<td><c:out value="${fn:substring(vo.uid, 0, 3)} - ${fn:substring(vo.uid, 3, 7)} - ${fn:substring(vo.uid, 7, 11)} "></c:out></td>
			</tr>
			<tr>
				<td>학교</td>
				<td><c:out value="${vo.schoolname}"></c:out></td>
			</tr>
			<tr>
				<td>학년반</td>
				<td><c:out value="${vo.gradeclass}"></c:out></td>
			</tr>
			<tr>
				<td>노선</td>
				<td><c:out value="${vo.route}"></c:out></td>
			</tr>
			<tr>
				<td>탑승장소</td>
				<td><c:out value="${vo.boardingplace}"></c:out></td>
			</tr>
		</table>
	</div>
	...
	<div class="b02 pd16">
		...
		<div class="mb16">
			<img src="views/img/img02.png">잔여 이용 횟수 <span class="fR"><b><c:out value="${vo.coupon}"></c:out></b>회</span>
		</div>
